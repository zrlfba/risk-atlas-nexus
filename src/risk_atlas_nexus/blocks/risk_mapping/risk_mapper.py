        ...
        if mapping_method == MappingMethod.SEMANTIC:
            ...
            for nr in new_risks:
                ...
                mapping = Mapping(subject_id= self._format_with_curie(nr.isDefinedByTaxonomy, nr.id), 
                                  ...
                                  object_id=self._format_with_curie(taxonomy_for_mapping[result_id.group(1).strip()],
                                                                    result_id.group(1)),
            ...
            for index, rl, in enumerate(rls):
                for risk in rl:
                    mapping = Mapping(subject_id= self._format_with_curie(new_risks[index].isDefinedByTaxonomy,
                                                                          new_risks[index].id),
